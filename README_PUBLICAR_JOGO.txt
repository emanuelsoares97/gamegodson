...
3. Não mover o index.html para fora da pasta, porque ele precisa das pastas js, css e assets ao lado.

Para publicar num site:
- Enviar todos estes ficheiros/pastas para a raiz do alojamento:
  index.html
  css/
  js/
  assets/
